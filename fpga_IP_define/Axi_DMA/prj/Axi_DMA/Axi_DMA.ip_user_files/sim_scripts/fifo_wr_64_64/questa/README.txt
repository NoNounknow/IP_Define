...
#
# Generated by export_simulation on Sat Dec 02 15:27:01 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './fifo_wr_64_64.sh' script.

./fifo_wr_64_64.sh -reset_run
...
./fifo_wr_64_64.sh -noclean_files

For more information on the script, please type './fifo_wr_64_64.sh -help'.
