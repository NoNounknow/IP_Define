...
HD_PWD='D:/three_verilog/fpga_IP_define/Axi_DMA/prj/Axi_DMA/Axi_DMA.runs/fifo_8_sys_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_8_sys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_8_sys.tcl
