...
HD_PWD='D:/three_verilog/fpga_IP_define/Axi_DMA/prj/Axi_DMA/Axi_DMA.runs/fifo_rd_64_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_rd_64_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_rd_64_8.tcl
