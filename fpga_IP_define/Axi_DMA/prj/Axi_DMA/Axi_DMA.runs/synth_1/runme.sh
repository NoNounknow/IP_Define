...
HD_PWD='D:/three_verilog/fpga_IP_define/Axi_DMA/prj/Axi_DMA/Axi_DMA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_dma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_dma.tcl
