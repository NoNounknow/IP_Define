...
HD_PWD='D:/three_verilog/fpga_IP_define/Bayer2RGB/prj/bayer2rgb_3x3/bayer2rgb_3x3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bayer2rgb_3x3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bayer2rgb_3x3.tcl
