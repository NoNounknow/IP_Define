# Runtime Tcl commands to interact with - DMA_Custom_v2_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/DMA_Custom_v2_0_include.tcl
...
# Test: S_AXI
set wdata_s_axi [get_init_data 0]
create_hw_axi_txn w_s_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_s_axi}
create_hw_axi_txn r_s_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
...
if { $DE == 01 } {
	...
	puts "Data comparison test fail for - S_AXI, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
