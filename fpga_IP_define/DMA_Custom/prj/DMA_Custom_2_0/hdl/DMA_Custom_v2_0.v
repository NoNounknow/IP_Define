...
`timescale 1 ns / 1 ps
	...
	(
        ...
        input  wire                              Enabled        ,
        // Ports of Input Data
        input  wire                              I_Pre_clk_CH0  ,
        input  wire                              I_Pre_vs_CH0   ,
        input  wire [Input_Data_width-1:0]       I_Pre_data_CH0 ,
        input  wire                              I_Pre_de_CH0   ,

		input  wire							     I_Post_clk_CH0     ,
		output wire							     O_Post_Start_CH0   ,
		output wire [Input_Data_width-1:0]	     O_Post_data_CH0    ,
		input  wire							     I_Post_de_CH0	 	,
		input   wire                             I_Post_vs_CH0		 
	);
...
// Instantiation of Axi Bus Interface S_AXI
	DMA_Custom # ( 
        ...
        .I_Pre_clk    ( I_Pre_clk_CH0   ),  
        .I_Pre_vs     ( I_Pre_vs_CH0    ),  
        .I_Pre_data   ( I_Pre_data_CH0  ),  
        .I_Pre_de	  ( I_Pre_de_CH0    ),      

        .I_Post_clk   ( I_Post_clk_CH0  ),     
        .O_Post_Start ( O_Post_Start_CH0),     
        .O_Post_data  ( O_Post_data_CH0 ),     
        .I_Post_de	  ( I_Post_de_CH0	),     
		.I_Post_vs	  ( I_Post_vs_CH0	),
