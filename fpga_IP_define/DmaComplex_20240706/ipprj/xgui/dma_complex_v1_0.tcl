...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "Test_Flow_Mode" -parent ${Page_0}
...
proc update_PARAM_VALUE.Test_Flow_Mode { PARAM_VALUE.Test_Flow_Mode } {
	# Procedure called to update Test_Flow_Mode when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.Test_Flow_Mode { PARAM_VALUE.Test_Flow_Mode } {
	# Procedure called to validate Test_Flow_Mode
	return true
}
...
proc update_MODELPARAM_VALUE.Test_Flow_Mode { MODELPARAM_VALUE.Test_Flow_Mode PARAM_VALUE.Test_Flow_Mode } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.Test_Flow_Mode}] ${MODELPARAM_VALUE.Test_Flow_Mode}
}
