...
#                script (type 'rdata_w256x512_r256x512.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rdata_w256x512_r256x512 xil_defaultlib.glbl -o rdata_w256x512_r256x512_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rdata_w256x512_r256x512_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rdata_w256x512_r256x512_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rdata_w256x512_r256x512_simv.daidir vcs_lib c.obj)
