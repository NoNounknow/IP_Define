...
#
# Script generated by Vivado on Sun Jul 07 21:16:52 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rdata_w256x512_r256x512.sh
...
#
# Usage        : rdata_w256x512_r256x512.sh
#                rdata_w256x512_r256x512.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rdata_w256x512_r256x512.sh [-reset_run]
#                rdata_w256x512_r256x512.sh [-reset_log]
#                rdata_w256x512_r256x512.sh [-help]
#
...
# script info
echo -e "rdata_w256x512_r256x512.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rdata_w256x512_r256x512.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rdata_w256x512_r256x512 xil_defaultlib.rdata_w256x512_r256x512 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rdata_w256x512_r256x512 -key {Behavioral:sim_1:Functional:rdata_w256x512_r256x512} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xil_23/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rdata_w256x512_r256x512.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rdata_w256x512_r256x512.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rdata_w256x512_r256x512.sh [-help]\n\
Usage: rdata_w256x512_r256x512.sh [-step]\n\
Usage: rdata_w256x512_r256x512.sh [-lib_map_path]\n\
Usage: rdata_w256x512_r256x512.sh [-reset_run]\n\
Usage: rdata_w256x512_r256x512.sh [-reset_log]\n\
Usage: rdata_w256x512_r256x512.sh [-keep_index]\n\
Usage: rdata_w256x512_r256x512.sh [-noclean_files]\n\n\
