...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "Cycle_width"

}

proc update_PARAM_VALUE.Cycle_width { PARAM_VALUE.Cycle_width } {
	# Procedure called to update Cycle_width when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.Cycle_width { PARAM_VALUE.Cycle_width } {
	# Procedure called to validate Cycle_width
	return true
}
...
proc update_MODELPARAM_VALUE.Cycle_width { MODELPARAM_VALUE.Cycle_width PARAM_VALUE.Cycle_width } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.Cycle_width}] ${MODELPARAM_VALUE.Cycle_width}
}
